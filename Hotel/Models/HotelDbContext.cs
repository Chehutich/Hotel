...
public partial class HotelDbContext : DbContext
{
    ...
    // (ПОВЕРНУЛИ) Цей метод знову використовує .env для підключення з правами root
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        if (!optionsBuilder.IsConfigured)
        {
            // (ВАЖЛИВО) Перевіряємо, чи AppContext вже має головний рядок
            // Це дозволяє LoginForm використовувати той самий DbContext
            ...
            {
                // (Стара логіка) Якщо AppContext порожній, завантажуємо з .env
                // Це потрібно для першого запуску LoginForm
                Env.Load();
                ...
                // Зберігаємо root-рядок для майбутнього використання
    ...
    public virtual DbSet<Staff> Staff { get; set; } // Важливо, що ця модель тут є
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AvailableRoomsPerType>(entity =>
        {
            ...
            entity.Property(e => e.AvailableRooms).HasColumnType("bigint(21)").HasColumnName("available_rooms");
        ...
        modelBuilder.Entity<Discount>(entity =>
        {
            ...
            entity.Property(e => e.DiscountConditions).HasMaxLength(255).HasColumnName("discount_conditions");
            entity.Property(e => e.DiscountDescription).HasColumnType("text").HasColumnName("discount_description");
            entity.Property(e => e.DiscountPercentage).HasPrecision(5, 2).HasColumnName("discount_percentage");
        });
        modelBuilder.Entity<DiscountUsage>(entity =>
        {
            entity.HasNoKey().ToView("discount_usage");
            entity.Property(e => e.DiscountDescription).HasColumnType("text").HasColumnName("discount_description");
            entity.Property(e => e.TotalBookings).HasColumnType("bigint(21)").HasColumnName("total_bookings");
        });
        modelBuilder.Entity<Guest>(entity =>
        {
            ...
            entity.Property(e => e.GuestFirstName).HasMaxLength(50).HasColumnName("guest_first_name");
            entity.Property(e => e.GuestLastName).HasMaxLength(50).HasColumnName("guest_last_name");
            entity.Property(e => e.IsRegularGuest).HasColumnName("is_regular_guest");
            entity.Property(e => e.PassportSeries).HasMaxLength(20).HasColumnName("passport_series");
        ...
        {
            entity.HasNoKey().ToView("guests_with_children_information");
            entity.Property(e => e.AgeOfChild).HasColumnType("int(11)").HasColumnName("age_of_child");
            ...
            entity.Property(e => e.IdGuest).HasColumnType("int(11)").HasColumnName("id_guest");
            entity.Property(e => e.IsRegularGuest).HasColumnName("is_regular_guest");
            entity.Property(e => e.NumberOfChild).HasColumnType("tinyint(4)").HasColumnName("number_of_child");
            entity.Property(e => e.PassportSeries).HasMaxLength(20).HasColumnName("passport_series");
            entity.Property(e => e.PhoneNumber).HasMaxLength(15).HasColumnName("phone_number");
        });
        modelBuilder.Entity<HotelRoom>(entity =>
        {
            ...
            entity.Property(e => e.IdRooms).HasColumnType("int(11)").HasColumnName("id_rooms");
        ...
        modelBuilder.Entity<MonthlyBooking>(entity =>
        {
            ...
            entity.Property(e => e.BookingMonth).HasMaxLength(5).HasColumnName("booking_month");
            entity.Property(e => e.TotalBookings).HasColumnType("bigint(21)").HasColumnName("total_bookings");
        });
        modelBuilder.Entity<PresenceOfChild>(entity =>
        {
            ...
            entity.Property(e => e.IdGuest).ValueGeneratedNever().HasColumnType("int(11)").HasColumnName("id_guest");
            entity.Property(e => e.AgeOfChild).HasColumnType("int(11)").HasColumnName("age_of_child");
            entity.Property(e => e.ChildrenPresence).HasColumnName("children_presence");
            entity.Property(e => e.NumberOfChild).HasColumnType("tinyint(4)").HasColumnName("number_of_child");
            entity.HasOne(d => d.IdGuestNavigation).WithOne(p => p.PresenceOfChild).HasForeignKey<PresenceOfChild>(d => d.IdGuest).OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("presence_of_children_ibfk_1");
        });
        modelBuilder.Entity<RegularGuestsInformation>(entity =>
        {
            entity.HasNoKey().ToView("regular_guests_information");
            entity.Property(e => e.DateOfBirth).HasColumnName("date_of_birth");
            entity.Property(e => e.GuestFirstName).HasMaxLength(50).HasColumnName("guest_first_name");
            entity.Property(e => e.GuestLastName).HasMaxLength(50).HasColumnName("guest_last_name");
            entity.Property(e => e.IdGuest).HasColumnType("int(11)").HasColumnName("id_guest");
        ...
        modelBuilder.Entity<Reservation>(entity =>
        {
            ...
            entity.Property(e => e.IdBooking).HasColumnType("int(11)").HasColumnName("id_booking");
            entity.Property(e => e.BookingStatus).HasMaxLength(20).HasColumnName("booking_status");
        ...
        modelBuilder.Entity<Staff>(entity =>
        {
            ...
            entity.Property(e => e.IdStaff).HasColumnType("int(11)").HasColumnName("id_staff");
            entity.Property(e => e.JobTitle).HasMaxLength(50).HasColumnName("job_title");
            entity.Property(e => e.StaffFirstName).HasMaxLength(50).HasColumnName("staff_first_name");
            entity.Property(e => e.StaffLastName).HasMaxLength(50).HasColumnName("staff_last_name");
            entity.Property(e => e.StaffPhoneNumber).HasMaxLength(15).HasColumnName("staff_phone_number");

            // (НОВІ ПОЛЯ) Додаємо мапінг для нових полів
